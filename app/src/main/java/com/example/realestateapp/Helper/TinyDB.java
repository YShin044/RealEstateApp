...
public class TinyDB {
    ...
    public ArrayList<PropertyDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PropertyDomain> playerList =  new ArrayList<PropertyDomain>();

        for(String jObjString : objStrings){
            PropertyDomain player  = gson.fromJson(jObjString,  PropertyDomain.class);
    ...
    public void putListObject(String key, ArrayList<PropertyDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(PropertyDomain player: playerList){
